...
export async function invoiceRoutes(app: FastifyInstance) {
  ...
  app.get('/revenue-trend', { preHandler: [authenticate] }, invoiceController.revenueTrend);
  ...
  app.delete('/:id', { preHandler: [authenticate, requireRole('super_admin', 'admin')] }, invoiceController.delete);
