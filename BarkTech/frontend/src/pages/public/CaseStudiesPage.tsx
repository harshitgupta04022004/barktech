...
const caseStudies: CaseStudy[] = [
  {
    ...
    excerpt: 'Skyline Print Pack transformed their packaging operations by upgrading to our fully automatic die cutting machine, achieving remarkable improvements in efficiency and waste reduction.',
  ...
  },
  {
    ...
    industry: 'E-Commerce',
    excerpt: 'By installing our high-speed automatic flute laminator, Gujarat Corrugators tripled their production output while maintaining consistent quality standards.',
  ...
  },
  {
    ...
    excerpt: 'Mumbai Pharma Solutions improved their pharmaceutical packaging compliance and efficiency by adopting our semi-automatic die cutting and creasing machine.',
  ...
  },
  {
    ...
    industry: 'E-Commerce',
    excerpt: 'PackRight Solutions in Delhi scaled their packaging operations to handle peak season volumes by investing in our high-speed automatic folder gluer machine.',
  ...
  },
  {
    ...
    industry: 'Automotive',
    excerpt: 'AutoPack Industries in Pune achieved precision packaging for sensitive automotive parts using our NC Cutter machine, eliminating damage during transit.',
  ...
  },
  {
    ...
    excerpt: 'TechPack India elevated their product packaging with vibrant, high-quality printing using our rotary printer, enhancing brand perception significantly.',
...
const industryColors: Record<string, string> = {
  ...
  FMCG: 'bg-purple-100 text-purple-700',
  Pharmaceutical: 'bg-cyan-100 text-cyan-700',
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <Link key={study.id} to={`/case-studies/${study.id}`}>
              <Card className="group h-full overflow-hidden transition-shadow hover:shadow-lg border-border">
                <div className="relative aspect-video overflow-hidden bg-muted">
                  ...
                  />
                  <span
                    className={`absolute left-3 top-3 rounded-full px-2.5 py-0.5 text-xs font-medium ${industryColors[study.industry] || 'bg-muted text-muted-foreground'}`}
                  >
                    {study.industry}
                  </span>
                </div>
                <CardContent className="p-5">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-foreground transition-colors group-hover:text-primary line-clamp-2">
                    {study.title}
                  </h3>
      ...
      <div className="mt-12 rounded-xl bg-primary/5 border border-primary/20 p-8 text-center">
        ...
        <h2 className="mb-2 text-xl font-bold text-foreground">Want Similar Results?</h2>
