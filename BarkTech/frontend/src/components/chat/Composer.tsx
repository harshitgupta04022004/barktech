...
export function Composer({ onSend, onStop, isStreaming, isUploading = false, onUpload }: ComposerProps) {
  ...
  return (
    <div
      className={cn(
        'rounded-2xl border bg-white dark:bg-[#2a2a2a] px-3.5 pt-3 pb-2.5 transition-all focus-within:shadow-md',
        isDragging
          ? 'border-[#e65100] dark:border-[#ff6d00] shadow-lg ring-2 ring-[#e65100]/20'
          : 'border-[#e5e0d6] dark:border-[#3d3a35]'
      )}
      onDrop={handleDrop}
            ...
            <div
              ...
              className={cn(
                ...
                file.status === 'error'
                  ...
                  : 'border-[#e5e0d6] bg-[#f8f5ef] dark:border-[#3d3a35] dark:bg-[#3d3a35]'
              )}
            >
              {file.preview ? (
                <img
                ...
                <span className={cn(
                  ...
                  file.status === 'error'
                    ...
                    : 'bg-[#e5e0d6] dark:bg-[#2a2a2a]'
                )}>
                  {getFileIcon(file.type)}
                </span>
              )}
              <div className="max-w-[120px]">
                <p className="truncate font-medium text-[#1a1a1a] dark:text-[#f5f0e8]">
                  {file.filename}
                </p>
              ...
              <button
                ...
                className="ml-1 flex h-5 w-5 items-center justify-center rounded-full text-[#999] hover:bg-[#e5e0d6] hover:text-[#1a1a1a] dark:hover:bg-[#2a2a2a] dark:hover:text-[#f5f0e8]"
              >
                <X className="h-3 w-3" />
              </button>
            </div>
