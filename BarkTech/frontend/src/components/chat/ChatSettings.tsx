...
export function ChatSettingsPanel({ open, onClose, settings, onSave }: ChatSettingsPanelProps) {
 ...
 {/* Panel */}
 <div className="fixed right-0 top-0 z-50 h-full w-[340px] border-l border-border bg-background shadow-xl overflow-y-auto">
 {/* Header */}
 ...
 ? 'border-[#e65100] bg-[#e65100]/5 bg-primary/10'
 ...
 localSettings.streaming ? 'bg-[#e65100]' : 'bg-muted'
 )}
 >
 <span
 className={cn(
 ...
 className="w-full rounded-lg bg-[#e65100] px-4 py-2.5 text-sm font-medium text-primary-foreground hover:bg-[#d45100] transition-colors"
 >
 Save Settings
 </button>
 </div>
